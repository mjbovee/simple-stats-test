describe( 'Adds test block, inputs data, and attempts to edit data', function() {
    ...
    it( 'Adds a block, adds content, edits the content, and publishes the page', function() {
        ...
        cy.get( '.editor-block-list__block' )
            ...
            .click()
        cy.get( '.statistic textarea.value').clear().type(value3).should( 'have.value', value3 ).blur()
        cy.wait(1000)
    ...
    it ( 'Checks ability to edit the block after it\'s been published', function() {
        ...
        cy.get( '.editor-block-list__block' )
            ...
            .should( 'have.class', 'is-hovered' )
            .click()
        cy.get( '.statistic textarea.value').clear().type(value1).should( 'have.value', value1 ).blur()
        cy.wait(1000)
        cy.get( '.editor-post-publish-panel__toggle' ).click()
        cy.wait(1000)
        cy.get( '.editor-post-publish-button' ).click()
