describe( 'Testing Simple Statistics Block', function() {
    ...
    it ( 'Tests that published values match input values - ' + title2, function() {
        ...
        cy.get( '.simple-statistic-countup-counted' ).should( 'have.attr', 'data-value', '' ) 
    ...
    it ( 'Tests that published values match input values - ' + title3, function() {
        ...
        cy.get( '.statistic:nth-of-type(1) .simple-statistic-countup-counted' ).should( 'have.attr', 'data-value', value1 )
        cy.get( '.statistic:nth-of-type(1) .label' ).should( 'have.text', value2 );
        cy.get( '.statistic:nth-of-type(2) .simple-statistic-countup-counted' ).should( 'have.attr', 'data-value', value3 )
    ...
    //     cy.get( '[aria-label="Disable tips"]' ).click()
    //     cy.get( '.simple-statistic-countup' ).should( 'have.attr', value1.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") )
    //     cy.get( '.label' ).should( 'have.text', value2 );
    // } )
    ...
    //     cy.get( '[aria-label="“' + title1 + '” (Edit)"]' ).click()
    //     cy.get( '[aria-label="Disable tips"]' ).click()
    //     cy.get( '.simple-statistic-countup' ).should( 'have.text', '0' ) 
    //     cy.get( '.label' ).should( 'have.text', '' );
    // } )
