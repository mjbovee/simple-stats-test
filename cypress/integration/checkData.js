describe( 'Adds test blocks, inputs data, and verifies that the data match across views', function() {
    ...
    it( 'Adds a simple stat block with value', function() {
        ...
        cy.get( '.statistic textarea.value').type(value1).should( 'have.value', value1)
        cy.get( '.statistic textarea.label').type(value2).should( 'have.value', value2).blur()
        cy.wait(1000)
    ...
    it ( 'Adds a simple stat block with two values', function() {
        ...
        cy.get( 'button' ).contains( 'Add Statistic:' ).click()
        cy.get( '.statistic textarea.value').type(value1).should( 'have.value', value1 )
        cy.get( '.statistic textarea.label').type(value2).should( 'have.value', value2 )
        cy.get( 'button' ).contains( 'Add Statistic:' ).click()
        cy.get( '.statistic:nth-of-type(2) textarea.value').type(value3).should( 'have.value', value3 )
        cy.get( '.statistic:nth-of-type(2) textarea.label').type(value4).should( 'have.value', value4 ).blur()
        cy.wait(1000)
        cy.get( '.editor-post-publish-panel__toggle' ).click()
        cy.wait(1000)
        cy.get( '.editor-post-publish-button' ).click()
